<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Consultar.aspx.cs" Inherits="Machotes_Consultar" 
    Async="true"%>
            ...
            <ContentTemplate>
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <b> <span class="glyphicon glyphicon-book"></span> Machotes</b>
                    </div>
                    <div class="panel-body"> 
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-md-4">
                                <asp:LinkButton runat="server" PostBackUrl="~/Machotes/Editar.aspx" CssClass="btn btn-primary d-inline"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo</asp:LinkButton>
                            </div>
                            <div class="col-md-4">
                                </div>
                        ...
                        <div class="row">                    
                            ...
                            <asp:GridView runat="server" CssClass="table table-striped table-bordered" Width="100%"
                                Height="50%" id="gridMachotes" AutoGenerateColumns="false" AllowPaging ="true" PageSize="10"
                                 OnPageIndexChanging="gridMachotes_PageIndexChanging" OnRowEditing="gridMachotes_RowEditing">   
                               <Columns>
